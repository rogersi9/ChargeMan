...
public class Vecteur implements Serializable {
	...
	public String toString(){
		return "[ x = " + new DecimalFormat("######.####").format(x) + ", y = " + new DecimalFormat("######.####").format(-1.0*y) + "]";
		//return "[ x = " +x + ", y = " +y + "]";
		
	}	
	public String toStringPetitNombres(){
		return "[ x = " + new DecimalFormat("######.####").format(x*Math.pow(10, 26)) + ", y = " + new DecimalFormat("######.####").format(-1.0*y*Math.pow(10, 26)) + "]";
